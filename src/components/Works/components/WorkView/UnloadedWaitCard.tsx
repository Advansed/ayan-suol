...
/** После разгрузки и отправки фото кузова: ждём завершения заказа */
                ...
                <div className={styles.notificationHeader}>
                    <div className={styles.notificationTitleRow}>
                        ...
                        <h2 className={styles.notificationTitle}>
                            {work.name || 'Груз разгружен'}
                        </h2>
                    </div>
                    <p className={styles.notificationSubtitle}>
                        Груз разгружен, фото кузова отправлено. Ожидайте завершения заказа со стороны
                        заказчика.
                    </p>
                </div>
            </div>
